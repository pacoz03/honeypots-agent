...
class SuricataHoneyPotDeployTool(BaseTool):
    """Un tool per deployare l'honeypot Suricata da un Dockerfile."""
    name: str = "suricata_deployer"
    description: str = (
        "Usa questo tool per deployare o aggiornare l'honeypot Dionaea. "
        "Prepara i file da 'config_source/suricata' nella directory 'honeypots/suricata', "
    ...
    HONEYPOT_TYPE: ClassVar[str] = "suricata"
    CONTAINER_NAME: ClassVar[str] = "suricata"
