...
class WordPotDeployTool(BaseTool):
    ...
    description: str = (
        "Usa questo tool per deployare o aggiornare l'honeypot Galah. "
        "Questo tool prepara i file necessari da 'config_source/galah' nella directory 'honeypots/galah', "
    ...
    HONEYPOT_TYPE: ClassVar[str] = "galah"
    CONTAINER_NAME: ClassVar[str] = "galah"
    ...
    def _run(self, *args, **kwargs) -> str:
        ...
        try:
            ...
            success_message = (
                ...
                f"o controlla la directory '{self.DEPLOY_DIR}'."
            )
